...
pub inline fn nandWithFlags(src_a: u8, src_b: u8, result: *u8, flags: *Flags) void {
    const result_8bit = ~(src_a & src_b);
...
pub inline fn rshWithFlags(src: u8, result: *u8, flags: *Flags) void {
...
pub fn signExtendu5u8(value: u5) u8 {
